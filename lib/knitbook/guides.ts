...
export const GUIDES: GuideArticle[] = [
  {
    ...
    description:
      "개구리와 상관없는 푸르시오, 거꾸로 걷는 팅크, 실과 치킨의 대결까지. 처음 들으면 웃기고 알고 나면 공감되는 뜨개 말을 풀어 봅니다.",
    publishedAt: "2026-09-16",
    updatedAt: "2026-09-16",
    readingMinutes: 8,
    sections: [
      {
        heading: "푸르시오는 개구리가 아닙니다",
        paragraphs: [
          ...
          "그중 가장 유명한 것이 푸르시오입니다. 영어권 뜨개인은 잘못된 코를 한꺼번에 푸는 일을 frogging이라고 부릅니다. 풀 때 속으로 외치는 rip it, rip it이 개구리 울음처럼 들린다는 말장난에서 나왔습니다. 한국 뜨개인은 이 장면을 더 정중하고 더 웃기게 바꿨습니다. 풀으시오가 아니라 푸르시오. 명령형인데, 누구에게 내리는 명령인지는 분명합니다. 며칠 공들인 소매를 바라보며 나 자신에게 내리는 선고입니다.",
          "한 코만 푸는 날도 있고, 열 단을 통째로 푸는 날도 있습니다. 게이지가 어긋난 몸판, 앞뒤를 바꿔 뜬 케이블, 겨울 실로 반팔을 떠 버린 선택까지. 시간은 돌아가지만 실은 남습니다. 그래서 뜨개에는 실패가 없다는 말이 나옵니다. 푸르시오는 포기가 아니라, 다음 단을 다시 고르는 일입니다.",
        ],
      },
      {
