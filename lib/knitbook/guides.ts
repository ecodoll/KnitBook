...
export const GUIDES: GuideArticle[] = [
  ...
  {
    slug: "using-knitbook",
    title: "KnitBook으로 도안·작품·실을 이어 가는 방법",
    shortTitle: "앱 사용법",
    description:
      "가입부터 도안 올리기, 실 등록, 작품 단수 기록까지. KnitBook 화면에서 실제로 누르는 버튼을 기준으로 사용 순서를 정리했습니다.",
    publishedAt: "2026-09-15",
    updatedAt: "2026-09-15",
    readingMinutes: 8,
    category: "basics",
    ...
    sections: [
      {
        heading: "한 계정 안에서만 이어집니다",
        paragraphs: [
          "KnitBook은 커뮤니티나 도안 상점이 아닙니다. 내가 산 PDF, 지금 뜨는 단수, 남은 실 무게를 한 계정에 모아 두는 개인 기록장입니다. 하단 탭은 홈, 도안, 작품, 실 네 칸뿐입니다. 다른 회원 피드를 둘러보거나 도안을 나눠 주는 기능은 없습니다.",
          "올린 PDF와 작품·실 사진은 본인만 봅니다. 그래서 유료 도안을 개인 보관용으로 올려도, KnitBook이 그 파일을 공개하거나 재판매하지 않습니다. 공개로 열려 있는 것은 이 가이드처럼 로그인 없이 읽는 글뿐입니다.",
        ],
      },
      {
        heading: "가입 후 홈에서 시작할 일",
        paragraphs: [
          "오른쪽 로그인 화면에서 회원가입을 고르면 이메일, 닉네임, 비밀번호를 넣습니다. 비밀번호는 8자 이상이고, 이용약관과 개인정보처리방침 동의가 필요합니다. 확인 메일이 오면 링크를 누른 뒤 로그인하세요. 비밀번호를 잊으면 로그인 화면의 「비밀번호를 잊으셨나요?」로 재설정 메일을 받을 수 있습니다.",
          "로그인하면 홈이 열립니다. 최근 작품 세 개, 최근 도안, 실 재고 요약이 한눈에 보입니다. 아직 아무것도 없으면 「아직 작품이 없어요」, 「등록된 도안이 없어요」, 「등록된 실이 없어요」가 나옵니다. 닉네임이나 프로필 사진은 오른쪽 위 아바타의 「프로필 편집」에서, 비밀번호는 「설정」에서 바꿉니다.",
        ],
      },
      {
        heading: "도안은 PDF만 올립니다",
        paragraphs: [
          "하단 「도안」 → 「등록」이 업로드 화면입니다. PDF 파일과 도안 이름은 필수이고, 디자이너와 메모는 비워 둬도 됩니다. 「도안 저장」을 누르면 바로 뷰어가 열립니다. 페이지를 넘기고 확대·축소할 수 있고, 자주 보는 페이지를 표시해 두거나 페이지마다 메모를 남길 수 있습니다. 페이지 메모는 입력칸에서 손을 떼면 저장됩니다.",
          "파일 이름이 pattern.pdf여도 도안 이름만 제대로 적으면 목록에서 찾습니다. 목록 위 검색창은 도안명, 디자이너, 태그를 봅니다. 이름을 나중에 바꾸려면 뷰어의 연필 아이콘으로 「도안 이름 변경」을 쓰면 됩니다. 뷰어를 보는 동안에는 하단 탭이 숨겨지니, 다른 메뉴로 가려면 「목록」을 누르세요.",
        ],
      },
      {
        heading: "실은 이름·브랜드·무게를 남깁니다",
        paragraphs: [
          "하단 「실」 → 「등록」에서 실 이름과 브랜드는 필수입니다. 색깔, 제품번호(색 번호나 LOT), 무게(g), 남은 무게(g), 사진을 같이 적으면 나중에 같은 타래를 찾기 쉽습니다. 사진은 JPEG, PNG, WebP, HEIC이고 8MB까지입니다. 「실 저장」 후 목록에서는 전체 / 사용 중 / 부족(남은 무게 100g 미만)으로 걸러 볼 수 있습니다.",
          "작품에 쓰다 남은 양은 상세 화면의 「재고 차감」에 그램을 넣어 줄입니다. 같은 실로 새 작품을 시작하려면 「작품에 사용」을 누르면 됩니다. 홈의 실 칸에는 종류 수와 총 그램, 부족·소진 예정이 보이니, 사기 전에 한 번만 확인해도 중복 구매가 줄어듭니다.",
        ],
      },
      {
        heading: "작품은 도안과 실을 붙인 뒤 단수를 적습니다",
        paragraphs: [
          "가장 덜 헷갈리는 순서는 도안 뷰어의 「작품 시작」입니다. 「이 도안으로 작품 시작」에서 작품 이름을 넣고 「이어서 실 고르기」를 누르면 새 작품 화면으로 이어집니다. 상태는 기본이 「진행 중」이고, 「계획」·「일시정지」·「완료」로 바꿀 수 있습니다. 게이지(10cm 가로 코수·세로 단수), 현재 단수, 총 단수, 시작일, 사용할 실의 예정·사용 수량을 적어 두면 며칠 쉬어도 이어서 뜰 수 있습니다.",
          "뜨는 날의 기록은 작품 상세의 「작업 기록」에 날짜, 현재 단수, 사진, 메모를 넣고 「기록 저장」하면 됩니다. 홈이나 작품 목록 타일의 + 버튼으로도 같은 기록을 남길 수 있습니다. 다 뜨면 상태만 「완료」로 바꾸면 됩니다. 바늘 호수나 사이즈처럼 칸이 없는 내용은 작품 메모에 한 줄로 적는 편이 빠릅니다.",
        ],
      },
    ],
  },
